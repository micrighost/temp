...
- **參數設置**:
  - **Lot**: 交易手數，默認為 `0.01`。
  - **CrossBodyThreshold**: 十字K最大實體比例（100%）。
  - **ThresholdMagnification**: 第二根K棒漲跌幅需達第一根實體的10倍。
  - **UpperLowerShadowThreshold**: 第二根K棒上下引線最大佔比要小於總漲幅的100%。
  - **MinShadowRatio**: 十字K棒上下引線最少要是實體的一倍。

- **策略邏輯**:
  - 當出現一星二陽的形態時，若出現一星一陽，則進場卡位。
  - 十字K（星）的實體需小於100%（漲跌幅），且上下引線需是實體的1倍。
  - 長紅K（陽）的實體需是十字K實體的10倍，且上下引線佔的總漲跌幅小於100%。
  - 星最高點要高於陽才能開多單。
